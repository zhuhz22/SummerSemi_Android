package com.java.zhuhongzhou.ui.favorites;
...
public class FavoritesFragment extends Fragment {
        ...
        (@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState){
            ...
            RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getContext());//TODO or getActivity()?
            recyclerView.setLayoutManager(layoutManager);
            databaseHelper = DatabaseHelper.getInstance(requireContext());//TODO or getactivity?
            ...
            new Thread(new Runnable() {
                @Override
                public void run() {
                    ArrayList<News> list=databaseHelper.getNewsListByTitleList("Favorite",databaseHelper.getTitleListOfTable("Favorite"));
